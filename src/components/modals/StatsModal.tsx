...
import { getExplanation } from './../../lib/hintsExplanations'
  ...
  return (
    ...
    >
      ...
      {(isGameLost || isGameWon) && (
        <div>
          <div className="mb-0 inline-block w-full rounded bg-green-700 p-1 text-center text-lg font-medium text-gray-900 dark:text-white dark:text-white dark:text-gray-100">
            <p>{getExplanation()}</p>
          </div>
